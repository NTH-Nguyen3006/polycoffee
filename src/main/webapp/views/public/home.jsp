...
.hero-badge {
    ...
    background: rgba(212,135,55,0.2); border: 1px solid rgba(212,135,55,0.5);
    color: #f6c06e; border-radius: 50px; padding: 6px 18px;
...
.section-title {
    ...
    font-weight: 800; color: #1a0a00; line-height: 1.2;
}
.section-title .accent { color: #e8821c; }

/* ========== FEATURES ========== */
.features-section { background: #faf8f5; }
.feature-card {
    background: #fff;
...
.product-card-home:hover .product-img-wrap img { transform: scale(1.08); }
.product-badge {
...
.btn-add-cart:hover { transform: scale(1.1); box-shadow: 0 6px 15px rgba(232,137,28,0.5); }
...
.testimonial-stars { color: #f6c06e; font-size: 1rem; }
.testimonial-text { color: rgba(255,255,255,0.85); font-size: 0.95rem; line-height: 1.8; }
.testimonial-avatar {
    width: 48px; height: 48px; border-radius: 50%;
    object-fit: cover; border: 2px solid rgba(246,192,110,0.5);
}
                ...
                <div class="hero-image-wrap">
                    ...
                    <div class="hero-float-card hero-float-card-1">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <div class="fw-bold" style="font-size:14px;color:#1a0a00;">Đảm Bảo Chất Lượng</div>
                    ...
                    <div class="hero-float-card hero-float-card-2">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div>
                                <div class="fw-bold" style="font-size:14px;color:#1a0a00;">Phục Vụ Nhanh</div>
...
<section class="features-section py-6 fade-in-section" style="padding:96px 0;">
    <div class="container">
        <div class="text-center mb-5">
            ...
            <h2 class="section-title">Trải Nghiệm <span class="accent">Khác Biệt</span><br>Tại Polycoffee</h2>
        </div>
        <div class="row g-4">
            <div class="col-md-4">
                            ...
                            <div class="product-card-home">
                                <div class="product-img-wrap">
                                    ...
                                    <c:if test="${p.featured}">
                                        <span class="product-badge"><i class="bi bi-star-fill me-1"></i>Nổi Bật</span>
                                    </c:if>
                                </div>
                                <div class="p-4">
                                    <c:if test="${not empty p.category}">
                                        <small class="text-muted text-uppercase fw-semibold" style="font-size:10px;letter-spacing:1px;">
                                            ${p.category.name}
                                        </small>
                                    </c:if>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="${pageContext.request.contextPath}/menu" class="btn-add-cart" title="Xem thực đơn">
                ...
                <c:otherwise>
                    ...
                    <c:forEach begin="1" end="4" varStatus="i">
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="product-card-home">
                                <div class="product-img-wrap">
                                    <img src="https://images.unsplash.com/photo-1509042239860-f550ce710b93?q=80&w=400&h=400&auto=format&fit=crop" alt="Cà phê">
                                    <span class="product-badge"><i class="bi bi-star-fill me-1"></i>Nổi Bật</span>
                                </div>
                                <div class="p-4">
                                    <small class="text-muted text-uppercase fw-semibold" style="font-size:10px;letter-spacing:1px;">Cà Phê</small>
                                    <h6 class="fw-bold mt-1 mb-2" style="color:#1a0a00;">Cà Phê Đặc Biệt #${i.index+1}</h6>
                                    <p class="text-muted small mb-3">Hương vị cà phê nguyên chất, thơm ngon đặc trưng.</p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <span class="product-price">35.000đ</span>
                                        <a href="${pageContext.request.contextPath}/menu" class="btn-add-cart">
                                            <i class="bi bi-plus-lg"></i>
                                        </a>
                                    </div>
                                </div>
...
<section class="testimonials-section py-6 fade-in-section" style="padding:96px 0;">
    <div class="container" style="position:relative;z-index:2;">
        <div class="text-center mb-5">
            <div class="section-badge" style="color:#f6c06e;border-color:rgba(246,192,110,0.4);background:rgba(246,192,110,0.1);">
                Khách Hàng Nói Gì
            </div>
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="testimonial-card">
                    ...
                    <p class="testimonial-text mb-4">"Cà phê ở đây thực sự tuyệt vời! Hương vị đậm đà, thơm ngon. 
                    Nhân viên phục vụ nhiệt tình và thân thiện. Tôi sẽ quay lại thường xuyên."</p>
                    <div class="d-flex align-items-center gap-3">
                        <img src="https://i.pravatar.cc/150?img=1" alt="Nguyễn Văn A" class="testimonial-avatar">
                        <div>
                            <div class="fw-bold text-white" style="font-size:14px;">Nguyễn Văn An</div>
                            <div style="color:rgba(255,255,255,0.5);font-size:12px;">Khách hàng thân thiết</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="testimonial-card">
                    <div class="testimonial-stars mb-3">★★★★★</div>
                    <p class="testimonial-text mb-4">"Không gian quán rất đẹp và ấm cúng. Menu đa dạng, phù hợp 
                    với mọi khẩu vị. Đặc biệt yêu thích ly Bạc Xỉu ở đây, không đâu ngon bằng!"</p>
                    <div class="d-flex align-items-center gap-3">
                        <img src="https://i.pravatar.cc/150?img=5" alt="Trần Thị B" class="testimonial-avatar">
                        <div>
                            <div class="fw-bold text-white" style="font-size:14px;">Trần Thị Bảo</div>
                            <div style="color:rgba(255,255,255,0.5);font-size:12px;">Học sinh FPT Polytechnic</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="testimonial-card">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <img src="https://i.pravatar.cc/150?img=8" alt="Lê Minh C" class="testimonial-avatar">
                        <div>
...
<section class="cta-section py-6 fade-in-section" style="padding:80px 0;">
    <div class="container text-center" style="position:relative;z-index:2;">
        ...
        <p class="text-white mb-5" style="opacity:0.85;font-size:1.1rem;max-width:500px;margin:0 auto 2rem;">
            Ghé thăm Polycoffee ngay hôm nay hoặc xem thực đơn để lựa chọn món yêu thích.
        </p>
        <div class="d-flex gap-3 justify-content-center flex-wrap">
            <a href="${pageContext.request.contextPath}/menu"
               class="btn btn-light btn-lg rounded-pill px-5 fw-bold shadow-sm"
               style="color:#e8821c;">
