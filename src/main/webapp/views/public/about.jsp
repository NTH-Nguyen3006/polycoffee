    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <style>
            ...
            .about-badge {
                ...
                border: 1px solid rgba(246, 192, 110, 0.4);
                color: #f6c06e;
                padding: 6px 18px;
                border-radius: 50px;
                font-size: 12px;
        ...
        <section class="about-hero">
            <div class="container about-hero-content text-center text-white">
                ...
                <h1 class="fw-bold mb-4" style="font-size:clamp(2.5rem,5vw,4rem);line-height:1.1;">
                    Câu Chuyện Của<br>
                    <span
                        style="background:linear-gradient(135deg,#f6c06e,#e8821c);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;">
                        Polycoffee
                    </span>
                </h1>
                <p
                    style="color:rgba(255,255,255,0.75);font-size:1.15rem;max-width:600px;margin:0 auto;line-height:1.8;">
                ...
                <div class="row g-4 fade-up">
                    <div class="col-md-6 col-lg-3">
                        <div class="value-card text-center">
                            ...
                            <p class="text-muted small mb-0">Chỉ sử dụng nguyên liệu tươi ngon, hạt cà phê thượng hạng
                                từ Đà Lạt và Buôn Ma Thuột.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <div class="value-card text-center">
                            ...
                            <p class="text-muted small mb-0">Cam kết sử dụng bao bì thân thiện môi trường, ủng hộ nông
                                dân địa phương.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <div class="value-card text-center">
                            ...
                            <p class="text-muted small mb-0">Polycoffee là nơi kết nối — không chỉ là quán cà phê, mà là
                                không gian sáng tạo.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <div class="value-card text-center">
                            ...
                            <p class="text-muted small mb-0">Liên tục cải tiến và sáng tạo menu, mang đến những trải
                                nghiệm hương vị mới mẻ.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row g-4 fade-up">
                    <div class="col-md-4 col-lg-3">
                        <div class="team-card">
                            <div class="team-img-wrap">
                                <img src="${pageContext.request.contextPath}/images/nam.jpg" alt="Trưởng Barista">
                            </div>
                            <div class="p-4">
                                <h6 class="fw-bold mb-1" style="color:#1a0a00;">Nguyễn Nam</h6>
                                <span class="team-role">Head Barista</span>
                                <p class="text-muted small mt-3 mb-0">5 năm kinh nghiệm, chuyên gia pha chế cà phê
                                    specialty.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-3">
                        <div class="team-card">
                            <div class="team-img-wrap">
                                <img src="${pageContext.request.contextPath}/images/bao.jpg" alt="Barista">
                            </div>
                            <div class="p-4">
                                <h6 class="fw-bold mb-1" style="color:#1a0a00;">Trân Vinh Bảo</h6>
                                <span class="team-role">Senior Barista</span>
                                <p class="text-muted small mt-3 mb-0">Chuyên gia về latte art, 3 năm kinh nghiệm pha
                                    chế.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-3">
                        <div class="team-card">
                            <div class="team-img-wrap">
                                <img src="${pageContext.request.contextPath}/images/nguyen.jpg" alt="Manager">
                            </div>
                            <div class="p-4">
                                <h6 class="fw-bold mb-1" style="color:#1a0a00;">Nguyễn Tấn Hoàng Nguyên</h6>
                                <span class="team-role">Quản Lý</span>
                                <p class="text-muted small mt-3 mb-0">Đảm bảo mỗi khách hàng có trải nghiệm tuyệt vời
                                    nhất.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-3">
                        <div class="team-card">
                            <div class="team-img-wrap">
                                <img src="${pageContext.request.contextPath}/images/fu.jpg" alt="Barista">
                            </div>
                            <div class="p-4">
                                <h6 class="fw-bold mb-1" style="color:#1a0a00;">Phạm Châu Lương Phú</h6>
                                <span class="team-role">Barista</span>
                                <p class="text-muted small mt-3 mb-0">Nhiệt huyết, sáng tạo — chuyên về các món trà sữa
                                    đặc biệt.</p>
                            </div>
                        </div>
                    </div>
        ...
        <section style="background:linear-gradient(135deg,#e8891c,#d4562a);padding:80px 0;">
            <div class="container text-center text-white">
                ...
                <p class="mb-4" style="opacity:0.85;font-size:1.05rem;">Chúng tôi luôn chào đón bạn với nụ cười và tách
                    cafe nóng hổi.</p>
