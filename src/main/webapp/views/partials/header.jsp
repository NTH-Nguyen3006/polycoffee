...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
        ...
        <nav class="pc-navbar navbar navbar-expand-lg ${isAdmin ? 'admin-nav' : 'public-nav'}" id="mainNavbar">
            <div class="container">
                <!-- Logo -->
                <a class="navbar-brand d-flex align-items-center gap-2 text-decoration-none" href="${contextPath}/home">
                    ...
                    <span class="fw-bold"
                        style="font-size:1.4rem;color:#fff;letter-spacing:-0.5px;">
                                ...
                                <c:choose>
                                    <c:when test="${not empty sessionScope.user}">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu pc-dropdown-menu dropdown-menu-end" aria-labelledby="userDrop">
                                                <c:if test="${sessionScope.user.role == 'ADMIN' or sessionScope.user.role == 'EMPLOYEE'}">
                                                    <li><a class="dropdown-item pc-dropdown-item" href="${contextPath}/admin/dashboard">
                                                        <i class="bi bi-speedometer2 me-2 text-warning"></i>Quản trị
                                                    </a></li>
                                                    <li><hr class="dropdown-divider mx-3 my-1"></li>
                                                </c:if>
                                                <li><a class="dropdown-item pc-dropdown-item" href="${contextPath}/profile">
                                                    <i class="bi bi-person me-2" style="color:#0d6efd;"></i>Hồ sơ
                                                </a></li>
                                                <li><a class="dropdown-item pc-dropdown-item text-danger" href="${contextPath}/logout">
                        ...
                        <c:otherwise>
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <a href="${contextPath}/home"
                                    style="color:rgba(255,255,255,0.6);text-decoration:none;font-size:0.85rem;padding:6px 14px;
